...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $id = $this->getRequest()->getParam('rfq_id');
            if ($id) {
                $model->load($id);
            }
            ...
            $this->_eventManager->dispatch(
                'rfq_prepare_save',
                ['rfq' => $model, 'request' => $this->getRequest()]
            );
            ...
            try {
                ...
                if ($this->getRequest()->getParam('back')) {
                    return $resultRedirect->setPath('*/*/edit', ['rfq_id' => $model->getId(), '_current' => true]);
                }
            ...
            return $resultRedirect->setPath('*/*/edit', ['rfq_id' => $this->getRequest()->getParam('rfq_id')]);
        }
        return $resultRedirect->setPath('*/*/');
    }
}
