...
use RouteMedia\Rfq\Model\Rfq as ModelRfq;
...
class InlineEdit extends \Magento\Backend\App\Action
{
     ...
     * @return void
     */
    protected function validatePost(array $pageData, ModelRfq $page, &$error, array &$messages)
    {
     ...
     * @return string
     */
    protected function getErrorWithPageId(ModelRfq $page, $errorText)
    {
     ...
     * @return $this
     */
    public function setRfqData(ModelRfq $page, array $extendedPageData, array $pageData)
    {
